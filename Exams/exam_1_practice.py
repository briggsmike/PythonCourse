...
book_ranking_numbers = [number for number in range(1,len(ordered_list_of_books)+1)]    #TODO: Use a list comprehension to generate a list of numbers between 1 and the number of books.
